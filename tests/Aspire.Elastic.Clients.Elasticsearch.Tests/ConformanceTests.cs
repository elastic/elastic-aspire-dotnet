...
public class ConformanceTests : ConformanceTestsBase<ElasticsearchClient, ElasticClientsElasticsearchSettings>, IClassFixture<ElasticsearchContainerFixture>
{
